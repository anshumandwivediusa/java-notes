...
<p align="center">
  <img width="500" height="350" alt="image" src="https://github.com/user-attachments/assets/85472cdf-e7a9-4c84-91dd-05fb8cd5912d" />
</p>
...
| --- | --- | --- |
| **Size** | Fixed at creation, cannot grow/shrink | Dynamic, resizes automatically. The resizing strategy is not 50% — it actually grows by ~1.5x (50% increase) each time. Use ensureCapacity() to avoid reloadCapacity trigger, Default 10, When full, new capacity = oldCapacity + (oldCapacity >> 1) → 15 |
